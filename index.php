                ...
                foreach ($result as $row) {
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            ...
                            <h4 style="color: white;"><?php echo $row['title']; ?></h4>
<p style="color: white;">
...
<div class="product pt_70 pb_70 bg-product">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            <div class="headline">
    <h2 style="color: white;"><?php echo $featured_product_title; ?></h2>
    <h3 style="color: white;"><?php echo $featured_product_subtitle; ?></h3>
</div>
...
<div class="product pt_70 pb_70 bg-product">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            <div class="headline">
    <h2 style="color: white;"><?php echo $popular_product_title; ?></h2>
    <h3 style="color: white;"><?php echo $popular_product_subtitle; ?></h3>
</div>
